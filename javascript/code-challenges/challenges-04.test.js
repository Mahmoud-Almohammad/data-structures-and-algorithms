...
const containsWorld = (input) => {
  // Solution code here...
  let worldStr = /world/g;
  return worldStr.test(input);
};
...
const isCapitalized = (str) => {
  ...
  let capitalizedArr =  str.match(capitalized);
...
let hangman = (str) => {
  // Solution code here...
  let hangman = /[aAeEiIoOuU]/g;
  let newStr = str.replace(hangman, '_');
  return newStr;
};
