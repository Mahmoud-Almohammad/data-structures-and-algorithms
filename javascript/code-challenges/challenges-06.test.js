...
const totalCharacters = (arr) => {
  ...
  arr.forEach( character => {
    ...
    if(character.children || character.children !== []) {
      numberOfCharacters += character.children.length;
    }
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach( character => {
    ...
    if (!deceasedSpouses.includes(character.spouse) && character.spouse !== null) {
      numberOfCharacters++;
    }
